...
import {updateCheckClient } from '../../actions/checkClient'

const CheckClientModal = ({ item, handleModal, getData,setLoader }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          await dispatch(updateCheckClient(item.id, checkData));
          handleModal();
          getData();
        } catch (error) {
...
export default CheckClientModal